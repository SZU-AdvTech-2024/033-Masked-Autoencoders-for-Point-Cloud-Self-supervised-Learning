...
def get_args():
    ...
    parser.add_argument(
        ...
        # default='./cfgs/finetune_modelnet.yaml',
        # default='./cfgs/fewshot.yaml',
    ...
    # parser.add_argument('--ckpts', type=str, default='/data/zhengmianjie/Point-MAE-main/log/modelnet_1k.pth', help='test used ckpt path')
    # parser.add_argument('--ckpts', type = str, default='/data/zhengmianjie/Point-MAE-main/experiments/fewshot/cfgs/default/ckpt-last.pth', help = 'test used ckpt path')
    # parser.add_argument('--ckpts', type=str, default='/data/zhengmianjie/Point-MAE-main/log/part_seg(1).pth',help='test used ckpt path')
    ...
    # args.experiment_path = os.path.join('./cfgs', Path(args.config).stem, Path(args.config).parent.stem,
    #                                     args.exp_name)
    # args.tfboard_path = None
